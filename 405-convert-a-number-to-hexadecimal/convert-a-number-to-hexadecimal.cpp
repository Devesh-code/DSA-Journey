...
do {
    ...
    ourNum /= 16;
    // Update ourNum by performing integer division by 16.
} while (ourNum);

return {str.rbegin(), str.rend()};
// Return the reversed view of the result string as the final hexadecimal representation with the help of iterators rbegin,rend.
    }
};